...
<section>
	<table class="striped">	
		...
		<tr class="jsgrid-alt-row">
			...
			<td>{{ $s->email }}</td>
			<td>
				<a href="editHeadOfStudentAffairs_{{$s->staf_id}}"><i class="Tiny material-icons ">mode_edit</i></a>
				<a href="headOfAffairs/delete/{{$s->staf_id}}"><i class="Tiny material-icons " style="color: red">delete</i></a>
			</td>
		</tr>
		@endforeach
	</tbody>
