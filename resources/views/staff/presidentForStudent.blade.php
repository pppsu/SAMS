	...
	<table class="striped">	
		<thead>
			...
			<tr class="jsgrid-alt-row">
				...
				<td>{{ $s->email }}</td>
				<td>
					<a href="editPresidentForStudent_{{$s->staf_id}}"><i class="Tiny material-icons ">mode_edit</i></a>
					<a href="presidentForStudent/delete/{{$s->staf_id}}"><i class="Tiny material-icons " style="color: red">delete</i></a>
				</td>
			</tr>
			@endforeach
		</tbody>
